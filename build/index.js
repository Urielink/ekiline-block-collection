...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)('ekiline-collection/ekiline-carousel-extra', {
  ...
  edit: props => {
    ...
    const TokenCategoriesSelect = () => {
      // el dato.
      const categories = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.useSelect)(select => select('core').getEntityRecords('taxonomy', 'category'), []); // Recursos.
      ...
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.FormTokenField, {
        ...
        onChange: tokens => {
          ...
          setSelectedCategories(tokens); //reset saved posts.
    ...
    function EntriesList(_ref) {
      ...
      console.log('original'); // console.log(posts)

      if (posts?.length > 0) {
        console.log(posts); // No requiero todos los valores solo 5.
        ...
        console.log(nuevoArray); // Guardar array en propiedades de bloque.
      ...
      const doLoop = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)("pre", null, JSON.stringify(attributes.SavePosts)));
      return doLoop;
    }
  ...
  save: _ref2 => {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)("div", blockProps, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)("ul", null, attributes.SavePosts?.map(post => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)("li", {
      key: post.id
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)("a", {
      href: post.link,
      title: (0,_wordpress_html_entities__WEBPACK_IMPORTED_MODULE_6__.decodeEntities)(post.title)
    }, (0,_wordpress_html_entities__WEBPACK_IMPORTED_MODULE_6__.decodeEntities)(post.title)), post.thumbnail ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.createElement)("img", {
      src: post.thumbnail
    }) : null, (0,_wordpress_html_entities__WEBPACK_IMPORTED_MODULE_6__.decodeEntities)(post.excerpt))))));
  }
});
