  ...
  edit: (props) => {
    ...
    return (
      <div {...blockProps}>
        {/* Inspector controles */}
        <InspectorControls>
          <PanelBody title={__('Accordion Settings', 'ekiline-accordion')} initialOpen>
            <ToggleControl
  ...
  edit: (props) => {
    ...
    return (
      <div {...blockProps}>
        {/* Inspector controles */}
        <InspectorControls>
          <PanelBody title={__('Accordion Item Params', 'ekiline-accordion')} initialOpen>
            <ToggleControl
        ...
        <RichText
          ...
          placeholder={__('Accordion Title', 'ekiline-accordion')}
        />
        <InnerBlocks
          template={CHILD_TEMPLATE}
        />
