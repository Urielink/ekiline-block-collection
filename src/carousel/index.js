 ...
 * @see https://developer.wordpress.org/block-editor/developers/block-api/#registering-a-block
 */
registerBlockType('ekiline-block-collection/ekiline-carousel', {
  /**
  ...
  /**
	 ...
	 */
  title: __('Carousel dynamic', 'ekiline-block-collection'),

  /**
	 * This is a short description for your block, can be translated with `i18n` functions.
	 * It will be shown in the Block Tab in the Settings Sidebar.
	 */
  description: __('Add a dynamic carousel to your posts, choose between posts, images, blocks and more.', 'ekiline-block-collection'),
