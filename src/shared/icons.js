/**
 * Crear múltiples íconos a partir de datos.
...
const iconData = [
  {
    name: 'collectionIcon',
    d: 'M18,0H2C0.9,0,0,0.9,0,2v16c0,1.1,0.9,2,2,2h16c1.1,0,2-0.9,2-2V2C20,0.9,19.1,0,18,0z M16,10.69H8.27V8.66h5.7l0-0.79l-2.25-2.23l-5.7-0.02l-0.01,6.5l2.25,2.23l5.7,0.02l0-1.68H16v3.71l-8.57-0.04L4,12.97V3.59l8.57,0.04L16,7.03V10.69z'
  },
  {
    name: 'accordionIcon',
  ...
  {
    name: 'navigationIcon',
    d: 'm17.52 8.86h-3.6v.9h3.6zm0 1.4h-3.6v.9h3.6zm-16.52-2.78v5.04h18v-5.04zm17.1 4.14h-16.2v-3.24h16.2zm-14.53-.45c.65 0 1.17-.52 1.17-1.17s-.52-1.17-1.17-1.17-1.17.52-1.17 1.17.52 1.17 1.17 1.17z'
  },
  {
    name: 'offcanvasIcon',
